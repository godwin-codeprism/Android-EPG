...
import ReactNative, { View, requireNativeComponent, StyleSheet, UIManager, ViewPropTypes } from 'react-native';
import PropTypes from 'prop-types';
import DataSource from './datasource';

class GRVItem extends Component {
  static propTypes = {
...
const NativeRecyclerViewItem = requireNativeComponent('GRVItem');

class GRView extends React.PureComponent {
  static propTypes = {
    ...View.propTypes,
    renderItem: PropTypes.func,
...
const NativeRecyclerView = requireNativeComponent('GRVBackendScrollView', GRView, nativeOnlyProps);
