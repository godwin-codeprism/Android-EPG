 ...
 */
public class GRVBackendScrollView extends RecyclerView {
    ...
    /*package*/ public static class ReactListAdapter extends Adapter<ConcreteViewHolder> {

        private final List<GRVItem> mViews = new ArrayList<>();
        private final GRVBackendScrollView mScrollView;
        private int mItemCount = 0;

        public ReactListAdapter(GRVBackendScrollView scrollView) {
            mScrollView = scrollView;
            //setHasStableIds(true);
        }

        public void addView(GRVItem child, int index) {
        ...
        public void removeViewAt(int index) {
            GRVItem child = mViews.get(index);
            if (child != null) {
                mViews.remove(index);
            }
        }
        ...
        public ConcreteViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            return new ConcreteViewHolder(recyclableWrapperViewGroup);
        }
        ...
        public GRVItem getViewByItemIndex(int position) {
    ...
    public GRVBackendScrollView(Context context) {
        ...
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(context){
            ...
            public boolean onRequestChildFocus(@NonNull RecyclerView parent, @NonNull State state, @NonNull View child, @Nullable View focused) {
                ...
                //disabled default scrolling on focus.
//                return true;
            }
        };
    ...
    /*package*/ void addViewToAdapter(GRVItem child, int index) {
