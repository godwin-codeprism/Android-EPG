...
/**
 * Created by Godwin Vinny Carole K on Tue, 15 Oct 2019 at 13:30.
 * Copyright (c) Code Prism Technologies Pvt Ltd
 */
public class RecyclableWrapperViewGroupChild extends ViewGroup {
    ...
    public RecyclableWrapperViewGroupChild(Context context, VerticalGridView.Adapter adapter) {
        super(context);
        mAdapter = adapter;
