...
/**
 * Created by Godwin Vinny Carole K on Mon, 07 Oct 2019 at 02:55.
 * Copyright (c) Code Prism Technologies Pvt Ltd
 */
public class ParentGridViewManager extends ViewGroupManager<ParentGridView> {
    private final static String REACT_CLASS = "ParentGridView";
    ...
    @NonNull
    @Override
    protected ParentGridView createViewInstance(@NonNull ThemedReactContext reactContext) {
        return new ParentGridView(reactContext);
    }

    @Override
    public void addView(ParentGridView parent, View child, int index) {
//        super.addView(parent, child, index);
    ...
    @Override
    public int getChildCount(ParentGridView parent) {
        return parent.getChildCountFromAdapter();
    }

    @Override
    public View getChildAt(ParentGridView parent, int index) {
        return parent.getChildAtFromAdapter(index);
    }

    @Override
    public void removeViewAt(ParentGridView parent, int index) {
        parent.removeViewFromAdapter(index);
    }

    @ReactProp(name = "itemCount")
    public void setItemCount(ParentGridView parent, int itemCount) {
    ...
    public void receiveCommand(
        ...
        switch (commandType) {
            case COMMAND_NOTIFY_ITEM_RANGE_INSERTED: {
                ...
                ParentGridAdapter adapter = (ParentGridAdapter) parent.getAdapter();
            ...
            case COMMAND_SCROLL_TO_INDEX: {
                ...
                ParentGridView.ScrollOptions options = new ParentGridView.ScrollOptions();
