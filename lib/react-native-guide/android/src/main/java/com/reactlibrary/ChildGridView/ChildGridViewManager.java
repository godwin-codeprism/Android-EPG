 ...
 */
public class ChildGridViewManager extends ViewGroupManager<ChildGridView> {
    private final static String REACT_CLASS = "ChildGridView";
    ...
    @NonNull
    @Override
    protected ChildGridView createViewInstance(@NonNull ThemedReactContext reactContext) {
        return new ChildGridView(reactContext);
    }

    @Override
    public void addView(ChildGridView parent, View child, int index) {
//        super.addView(parent, child, index);
    ...
    @Override
    public int getChildCount(ChildGridView parent) {
        return parent.getChildCountFromAdapter();
    }

    @Override
    public View getChildAt(ChildGridView parent, int index) {
        return parent.getChildAtFromAdapter(index);
    }

    @Override
    public void removeViewAt(ChildGridView parent, int index) {
        parent.removeViewFromAdapter(index);
    }

    @ReactProp(name = "itemCount")
    public void setItemCount(ChildGridView parent, int itemCount) {
    ...
    public void receiveCommand(
        ...
        switch (commandType) {
            ...
            case COMMAND_SCROLL_TO_INDEX: {
                ...
                ChildGridView.ScrollOptions options = new ChildGridView.ScrollOptions();
