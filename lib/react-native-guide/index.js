...
import ReactNative, { View, requireNativeComponent, StyleSheet, UIManager, ViewPropTypes, NativeModules, Text } from 'react-native';
...
const ShowView = requireNativeComponent('ShowView');
